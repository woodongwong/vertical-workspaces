...
const SearchControllerCommon = {
    _onStageKeyPress(actor, event) {
        ...
        // Since GS 51, event is no longer provided due to the use of Clutter.KeyController instead of key event directly
        let symbol = event?.get_key_symbol();
        symbol = symbol ?? this._stageKeyController.get_key()[1];
        ...
        // Since GS 51, the search is triggered differently
